...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Publications in reversed chronological order. Also available on [Google Scholar](https://scholar.google.com/citations?user=UfL_wmMAAAAJ&amp;hl=en).",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          title: 'I will be joining IBM Quantum as a research intern in Summer 2026....',
          description: "",
